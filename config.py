...
class Config(object):
    # Bot Information 
    TECH_VJ_BOT_TOKEN = os.environ.get("TECH_VJ_BOT_TOKEN", "7415321743:AAEIl9Of_3RlaocpJbKtQ7KKnqYMPz9_QJY")
    TECH_VJ_BOT_USERNAME = os.environ.get("TECH_VJ_BOT_USERNAME", "@Raistar4447bot") # Bot username without @.
    
    # The Telegram API things
    TECH_VJ_API_ID = int(os.environ.get("TECH_VJ_API_ID", "25799570"))
    TECH_VJ_API_HASH = os.environ.get("TECH_VJ_API_HASH", "d011931358d4718f04ffc9354cd9b118")
    ...
    TECH_VJ_OWNER_ID = int(os.environ.get("TECH_VJ_OWNER_ID", "862280924")) 
    TECH_VJ_SESSION_NAME = "VJ-URL-UPLOADER-BOT"
    
    # database uri (mongodb)
    TECH_VJ_DATABASE_URL = os.environ.get("TECH_VJ_DATABASE_URL", "mongodb+srv://ankitagowda22222:r33WYq4YG0T9wLRZ@cluster0.xc8furt.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
    TECH_VJ_MAX_RESULTS = "50"

    # channel information
    TECH_VJ_LOG_CHANNEL = int(os.environ.get("TECH_VJ_LOG_CHANNEL", "1002196312598")) # your log channel id and make bot admin in log channel with full right 
    ...
    TECH_VJ_API = environ.get('Ng_API', 'd011931358d4718f04ffc9354cd9b118') # your url shortner api
